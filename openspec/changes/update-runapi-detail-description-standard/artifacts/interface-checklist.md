...
- [x] `GET /apis/appbackups.testudo.softcdata.com/v1/appbackups/:name/backups/:backupName/download` - RunAPI 状态：已存在；Target ID：`1bd135d66a001001`；Handler：`c.downloadBackup`；类型：HTTP；目标动作：更新为平台代理下载签发语义并保留原说明；处理状态：已完成
